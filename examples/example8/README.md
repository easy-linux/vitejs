# Example 8 for Vitejs

## **Добаляем postcss-uncss плагин (не делайте этого для сайтов или приложений с динамическим контентом), а также раскладываем различные типы файлов в отдельные папки каталога assets**
